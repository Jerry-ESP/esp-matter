...
extern "C" void app_main()
{
    ...
    air_quality_sensor::config_t air_config;

    endpoint_t *endpoint = air_quality_sensor::create(node, &air_config, ENDPOINT_FLAG_NONE, nullptr);
    carbon_monoxide_concentration_measurement::config_t cm_config;
    carbon_monoxide_concentration_measurement::create(endpoint, &cm_config, CLUSTER_FLAG_SERVER, carbon_monoxide_concentration_measurement::feature::numeric_measurement::get_id());
