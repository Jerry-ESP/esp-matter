...
void commissioning_success_callback(chip::ScopedNodeId peer_id)
{
...
void commissioning_failure_callback(chip::ScopedNodeId peer_id, CHIP_ERROR error, chip::Controller::CommissioningStage stage,
...
static void custom_ota_event_handler()
{
    ...
    case kOTAPending: {
        ...
        char cmd_data[] = "{\"0:U64\": 112233, \"1:U64\": 65521, \"2:U8\": 0, \"4:U16\": 0}";
