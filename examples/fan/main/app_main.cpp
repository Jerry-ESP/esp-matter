...
extern "C" void app_main()
{
    ...
    cluster::fan_control::feature::multi_speed::add(cluster, &multi_speed_config);

    cluster::fan_control::feature::fan_auto::add(cluster);

    cluster::fan_control::feature::rocking::config_t rocking_config;
    cluster::fan_control::feature::rocking::add(cluster, &rocking_config);
    ...
    cluster::fan_control::feature::airflow_direction::config_t airflow_config;
    cluster::fan_control::feature::airflow_direction::add(cluster, &airflow_config);
