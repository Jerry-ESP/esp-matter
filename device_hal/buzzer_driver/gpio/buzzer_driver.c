...
static const char *TAG = "buzzer_driver_gpio";
...
buzzer_driver_handle_t buzzer_driver_init(buzzer_driver_config_t *config)
{
    ...
    return (buzzer_driver_handle_t)(config->channel + 1);
}

static esp_err_t buzzer_driver_set_brightness(buzzer_driver_handle_t handle, uint8_t brightness)
{
    esp_err_t err;
...
esp_err_t buzzer_driver_set_power(buzzer_driver_handle_t handle, bool power)
{
    ...
    return buzzer_driver_set_brightness(handle, current_brightness);
}
