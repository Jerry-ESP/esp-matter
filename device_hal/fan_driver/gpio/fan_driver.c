...
static const char *TAG = "fan_driver_gpio";
...
fan_driver_handle_t fan_driver_init(fan_driver_config_t *config)
{
    ...
    return (fan_driver_handle_t)(config->channel + 1);
}

static esp_err_t fan_driver_set_brightness(fan_driver_handle_t handle, uint8_t brightness)
{
    esp_err_t err;
...
esp_err_t fan_driver_set_power(fan_driver_handle_t handle, bool power)
{
    ...
    return fan_driver_set_brightness(handle, current_brightness);
}
